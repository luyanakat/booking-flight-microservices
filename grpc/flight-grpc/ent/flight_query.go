...
func (fq *FlightQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (fq *FlightQuery) FirstIDX(ctx context.Context) int64 {
...
func (fq *FlightQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (fq *FlightQuery) OnlyIDX(ctx context.Context) int64 {
...
func (fq *FlightQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (fq *FlightQuery) IDsX(ctx context.Context) []int64 {
	ids, err := fq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (fq *FlightQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(flight.Table, flight.Columns, sqlgraph.NewFieldSpec(flight.FieldID, field.TypeInt64))
	_spec.From = fq.sql
