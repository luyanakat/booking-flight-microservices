...
import (
	...
	"mock-project/grpc/user-grpc/ent/migrate"
...
func (c *Client) Intercept(interceptors ...Interceptor) {
	c.AccessLevel.Intercept(interceptors...)
...
func (c *AccessLevelClient) UpdateOne(al *AccessLevel) *AccessLevelUpdateOne {
	mutation := newAccessLevelMutation(c.config, OpUpdateOne, withAccessLevel(al))
...
func (c *AccessLevelClient) DeleteOne(al *AccessLevel) *AccessLevelDeleteOne {
...
type (
	hooks struct {
		AccessLevel, User []ent.Hook
	}
	inters struct {
		AccessLevel, User []ent.Interceptor
	}
)
