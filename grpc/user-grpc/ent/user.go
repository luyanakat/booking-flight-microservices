...
func (*User) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case user.FieldID, user.FieldCustomerID, user.FieldAccessID:
...
func (u *User) String() string {
	...
	builder.WriteString(fmt.Sprintf("%v", u.CustomerID))
	builder.WriteString(", ")
	builder.WriteString("access_id=")
	builder.WriteString(fmt.Sprintf("%v", u.AccessID))
	builder.WriteString(", ")
